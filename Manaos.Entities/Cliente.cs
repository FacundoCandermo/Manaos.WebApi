...
{
    public class Cliente : IEntidad, IClassMethods
    {
        public Cliente()
        {
        ...
        public void SetCuit(string? cuit)
        {
            if (cuit != null && string.IsNullOrWhiteSpace(cuit))
                throw new ArgumentException("El CUIT del cliente no puede estar vacío.");
            Cuit = cuit;
        }
        ...
        public void SetEmail(string? mail)
        {
            if (mail != null && (string.IsNullOrWhiteSpace(mail) || (!mail.Contains("@") && !mail.Contains(".com"))))
                throw new ArgumentException("El email del cliente no puede estar vacío o contener un @.");
            Email = mail;
        }
        ...
        public void SetDireccion(string? direccion)
        {
            if (direccion != null && string.IsNullOrWhiteSpace(direccion))
                throw new ArgumentException("La dirección del cliente no puede estar vacía.");
            Direccion = direccion;
        }
